...
const DEFAULT_PIN_ATTEMPT_DELAY: u32 = 100; // In milliseconds.
...
fn main() {
    ...
    let mut uart0 = serialport::new(args.uart0_serial_file_name, BAUD_RATE).timeout(Duration::from_millis(20))
        .open()
