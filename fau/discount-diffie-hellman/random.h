...
extern void FillEntropy64(uint8_t *entropy);
extern void SetEntropyUsing(uint8_t *msg, unsigned long len);
extern void RandomSeed(uint8_t *digest);
extern uint32_t GetEntropyAddress(void);
